...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_open_loop = QtWidgets.QPushButton(self.centralwidget)
        self.button_open_loop.setObjectName("button_open_loop")
        self.gridLayout_4.addWidget(self.button_open_loop, 1, 0, 1, 1)
        self.button_closed_loop = QtWidgets.QPushButton(self.centralwidget)
        self.button_closed_loop.setObjectName("button_closed_loop")
        self.gridLayout_4.addWidget(self.button_closed_loop, 3, 0, 1, 1)
        self.splitter = QtWidgets.QSplitter(self.centralwidget)
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName("splitter")
        self.label_20 = QtWidgets.QLabel(self.splitter)
        self.label_20.setObjectName("label_20")
        self.line_edit_v_percent = QtWidgets.QLineEdit(self.splitter)
        ...
        self.gridLayout.addWidget(self.line_edit_alpha, 0, 1, 1, 1)
        self.gridLayout_8.addLayout(self.gridLayout, 3, 0, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.push_button_angle_feedback, 4, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.line_edit_dth0_dt, 1, 2, 1, 1)
        self.line_edit_th0 = QtWidgets.QLineEdit(self.centralwidget)
        self.line_edit_th0.setObjectName("line_edit_th0")
        self.gridLayout_3.addWidget(self.line_edit_th0, 0, 2, 1, 1)
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 0, 0, 1, 2)
        self.gridLayout_8.addLayout(self.gridLayout_3, 6, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.push_button_position_control, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.push_button_velocity_control, 0, 1, 1, 1)
        self.gridLayout_7.addLayout(self.gridLayout_2, 2, 0, 1, 1)
        self.gridLayout_8.addLayout(self.gridLayout_7, 7, 0, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.push_button_start_stop, 0, 0, 1, 2)
        self.label_19 = QtWidgets.QLabel(self.centralwidget)
        self.label_19.setObjectName("label_19")
        self.gridLayout_8.addWidget(self.label_19, 5, 0, 1, 2)
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setObjectName("label_4")
        self.gridLayout_8.addWidget(self.label_4, 2, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_open_loop.setText(_translate("MainWindow", "Open Loop Control"))
        self.button_closed_loop.setText(_translate("MainWindow", "Closed Loop Control"))
