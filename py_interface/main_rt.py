...
def gui_main():
	try:
		...
		ui.button_tune_velocity_control_m1.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_velocity_control_m2_1.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_velocity_control_m2_2.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_position_control_m1.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_position_control_m2_1.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_position_control_m2_2.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_position_control_m3_1.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_position_control_m3_2.clicked.connect(lambda: fun_9(ui))
		ui.button_tune_position_control_m3_3.clicked.connect(lambda: fun_9(ui))
