...
def gui_main():
	try:
		...
		ui.button_tune_velocity_control_m2_2.clicked.connect(lambda: fun_12(ui))
		ui.button_tune_position_control_m1.clicked.connect(lambda: fun_13(ui))
		ui.button_tune_position_control_m2_1.clicked.connect(lambda: fun_14(ui))
		ui.button_tune_position_control_m2_2.clicked.connect(lambda: fun_15(ui))
